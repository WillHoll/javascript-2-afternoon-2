...
function absence(devMountainEmployees) {
...
let user2= {
  name: 'Nathan Loder',
  email: 'power.Loder@buffboiis.com',
  password: 'BIKES!',
  username: 'TheLlamaKing'
}
let user3 = {
  name: 'Will Hollingsworth',
  email: 'willyouhollmy.worth@helpme.com',
  password: 'pa$$word',
  username: 'BilliamBobert'
}
users.push(user1);
users.push(user2);
users.push(user3);
